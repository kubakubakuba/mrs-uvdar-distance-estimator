...
by the fact that the LEDs, when close to the camera, can be percieved as multiple sources,
...
\begin{figure}[htbp]
  ...
  the led source is caused by light diffraction affecting that is happening when the intense
